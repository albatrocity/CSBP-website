        ...
        playlistMgr = function() {
            ...
            function buildPlaylist() {
                ...
                for (var j = 0; j < myPlaylist.length; j++) {
                    ...
                    $track.find(cssSelector.title).html(trackName(j)).append("<span class='artist'>" + myPlaylist[j].artist + "</span>");
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player">' +
                        ...
                        '            <div class="main">' +
                        '                <div class="previous jp-previous"><i class="icon-backward"></i></div>' +
                        '                <div class="play jp-play"><i class="icon-play"></i></div>' +
                        '                <div class="pause jp-pause"><i class="icon-pause"></i></div>' +
                        '                <div class="next jp-next"><i class="icon-forward"></i></div>' +
